...
const SYMBOL_INFO: Record<string, { name: string; color: string; category: string; description: string }> = {
  ...
  VIX: {
    ...
    color: '#ef4444',
    category: '변동성',
    description: 'S&P 500 옵션 가격에서 산출된 변동성 지수. 시장의 공포와 불확실성을 측정하는 "공포 지수"입니다. 높을수록: 시장 불안과 공포 확대, 주가 하락 가능성. 낮을수록: 시장 안정, 투자자 낙관론 우세. 보통 20 이하면 안정, 30 이상이면 불안한 시장 상태입니다.'
  },
  ...
  GOLD: {
    ...
    color: '#f59e0b',
    category: '원자재',
    description: '금 선물 가격. 인플레이션 헤지 자산이자 대표적인 안전자산입니다. 높을수록: 경기 불확실성 증가, 인플레이션 우려, 달러 약세 신호. 낮을수록: 시장 안정, 위험자산(주식) 선호 경향. 금리가 오르면 금은 약세를 보이는 경향이 있습니다.'
  },
  WTI: {
    name: 'WTI 원유',
    color: '#000000',
    category: '원자재',
    description: '서부 텍사스산 원유 선물 가격. 글로벌 경기와 인플레이션의 선행지표입니다. 높을수록: 인플레이션 압력 증가, 글로벌 수요 강세 신호. 낮을수록: 경기 둔화 우려, 수요 감소 예상. 급등 시 소비자 물가 부담이 커지고 기업 비용도 상승합니다.'
  },
  ...
  DXY: {
    ...
    color: '#10b981',
    category: '통화',
    description: '주요 6개 통화(유로, 엔, 파운드 등) 대비 달러 가치 지수입니다. 높을수록: 달러 강세, 글로벌 유동성 축소, 신흥국 부담 증가, 금/원자재 약세. 낮을수록: 달러 약세, 위험자산 선호, 신흥국 자산 강세. 연준 긴축 시 상승하고 완화 시 하락합니다.'
  },
  USD_KRW: {
    name: '원/달러 환율',
    color: '#3b82f6',
    category: '통화',
    description: '1달러를 사는데 필요한 원화 금액입니다. 높을수록(환율 상승): 원화 약세, 수출 유리하지만 수입 물가 상승, 해외 투자 부담 증가. 낮을수록(환율 하락): 원화 강세, 수입 물가 안정, 해외 여행/투자 유리. 한국 투자자는 해외 주식 투자 타이밍을 잡는 중요한 지표입니다.'
  },
  ...
  US_2Y: {
    ...
    color: '#8b5cf6',
    category: '금리',
    description: '미국 2년 만기 국채 수익률. 연준의 정책금리 변화를 가장 민감하게 반영하는 지표입니다. 높을수록: 연준 긴축 기대 확대, 단기 자금 비용 상승. 낮을수록: 금리 인하 또는 완화 기대, 경기 둔화 우려. 연준 회의 전후로 크게 변동하며 정책 방향을 예측하는 핵심 지표입니다.'
  },
  SPREAD_10Y_2Y: {
    name: '10Y-2Y Spread',
    color: '#ec4899',
    category: '금리',
    description: '10년물과 2년물 금리 차이. 정상적으로는 장기 금리가 단기 금리보다 높아 양수입니다. 양수(정상): 정상적인 경기 사이클, 장기 성장 기대. 음수(역전): 단기 금리가 장기 금리보다 높은 비정상 상태로, 과거 경기 침체 전에 반복적으로 발생한 신호입니다. 역전 후 6~18개월 내 경기 침체가 올 가능성이 높습니다.'
  },
  US_10Y_REAL: {
    name: '미국 10년물 실질금리',
    color: '#14b8a6',
    category: '금리',
    description: '10년 국채 금리에서 기대 인플레이션을 뺀 실질 수익률입니다. 높을수록: 채권의 실질 매력 증가, 금/성장주 약세(대체 투자처 매력 하락). 낮을수록(특히 마이너스): 금과 성장주 강세, 실물자산 선호. 실질금리가 너무 높으면 주식 밸류에이션에 부담을 주고, 마이너스면 금 같은 무이자 자산의 매력이 커집니다.'
  },
  ...
  CPI_YOY: {
    ...
    color: '#f97316',
    category: '인플레이션',
    description: '소비자물가지수의 전년 대비 상승률. 일반인이 체감하는 물가 수준을 나타냅니다. 높을수록: 물가 상승, 구매력 저하, 연준 긴축 압력 증가(금리 인상 가능성). 낮을수록: 물가 안정 또는 디플레이션 우려, 완화적 정책 가능. 보통 연준은 2% 목표를 두고 있으며, 3~4% 이상이면 긴축에 나서게 됩니다.'
  },
  CORE_CPI_YOY: {
    name: 'Core CPI (전년비)',
    color: '#dc2626',
  ...
  PCE_YOY: {
    ...
    color: '#ea580c',
    category: '인플레이션',
    description: '개인소비지출 물가지수. 연준이 정책 결정 시 가장 중요하게 보는 인플레이션 지표입니다. 높을수록: 연준 긴축(금리 인상) 가능성 증가, 소비자 부담 확대. 낮을수록: 완화적 정책 기조 유지 가능, 물가 안정 신호. CPI보다 소비 패턴 변화를 잘 반영하며, 연준의 2% 목표 달성 여부를 판단하는 핵심 지표입니다.'
  },
  INFLATION_EXP_5Y: {
    name: '5년 인플레이션 기대',
    color: '#f59e0b',
    category: '인플레이션',
    description: '시장 참여자들이 예상하는 향후 5년간 평균 인플레이션율입니다. 높을수록: 인플레이션이 고착화(anchoring)될 우려, 물가 상승 심리 확산, 연준의 긴축 압력 증가. 낮을수록: 물가 안정 기대, 연준 정책 신뢰도 유지. 인플레이션 기대가 실제 인플레이션을 만들기 때문에 이 지표가 급등하면 연준은 더 공격적으로 긴축합니다.'
  },
}
